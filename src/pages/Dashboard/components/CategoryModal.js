...
function CategoryModal({ addCategoryModal, setAddCategoryModal }) {
    ...
    const active = 'bg-blue-600 text-white font-bold px-10 rounded-lg transition duration-500 ease-in-out transform';
...
{/* =========================================================================================================== */}
                                ...
                                <div className=" flex flex-col items-center justify-center w-full mt-6 mb-6 overflow-hidden">
                                    <div
                                        className="flex space-x-8 border-solid border-2 border-blue-600 rounded-xl transition-transform ease-in ">
...
{/* =========================================================================================================== */}
                  ...
                  {/* create a switch case to toggle between the add, edit and delete category */}
...

                                {
                                    ...
                                    checkedState === 'add' ? <AddCategory />
                                        ...
                                        : checkedState === 'edit' ? <EditCategory />
                                            ...
                                            : checkedState === 'delete' && <DeleteCategory setAddCategoryModal={setAddCategoryModal} />
